...
<div id="tab-dudika" class="tab-pane">
    <div class="card-app">
        <div class="card-header-app">
            ...
            <span style="font-size:0.75rem;color:var(--text3);">Edit nama DUDIKA akan memperbarui semua siswa di DUDIKA tersebut</span>
        </div>
        <div style="overflow-x:auto;">
            <table id="tabelDudika" class="edit-table" style="width:100%">
                <thead>
                    <tr><th>#</th><th>Nama DUDIKA</th><th>Alamat</th><th>No. Telepon</th><th>Pembimbing</th></tr>
                </thead>
                <tbody>
                    <?php foreach ($dudika as $i => $d): ?>
                    <tr data-old-nama="<?= htmlspecialchars($d['nama_dudika']) ?>" data-table="dudika">
                        <td style="color:var(--text3);font-size:0.72rem;"><?= $i+1 ?></td>
                        <td><span class="editable" contenteditable="true" data-field="nama_dudika" style="min-width:160px;"><?= htmlspecialchars($d['nama_dudika']) ?></span></td>
                        <td><span class="editable" contenteditable="true" data-field="alamat_dudika" style="min-width:140px;"><?= htmlspecialchars($d['alamat_dudika'] ?? '') ?></span></td>
                        <td><span class="editable" contenteditable="true" data-field="nomor_telepon_dudika"><?= htmlspecialchars($d['nomor_telepon_dudika'] ?? '') ?></span></td>
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-lg-6">
            <div class="card-app">
                ...
                <div class="card-body-app">
                    <p style="font-size:0.83rem;color:var(--text2);margin-bottom:1rem;">
...
document.querySelectorAll('.editable').forEach(cell => {
    ...
    cell.addEventListener('blur', () => {
        ...
        if (table === 'pembimbing') {
            ...
            body.append('old_nama', row.dataset.oldNama);
            // Update old_nama jika nama_dudika yang diubah
            if (field === 'nama_dudika') row.dataset.oldNama = value;
        }
